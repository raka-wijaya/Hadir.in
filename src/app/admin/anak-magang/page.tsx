...
export default function AdminAnakMagangPage() {
  ...
  const handleAddIntern = async (
    ...
    try {
      ...
      setBannerAlert({
        ...
        message: `Data anak magang "${newName}" berhasil ditambahkan.`,
        color: "green",
      });
      ...
      showAlert(
        err?.message ||
          "Gagal menambahkan data anak magang.",
        "Gagal Tambah Data",
        "red"
      );
    } finally {
  ...
  const handleUpdateIntern = async (
    ...
    try {
      ...
      showAlert(
        `Data peserta "${editName}" berhasil diperbarui.`,
        "Perubahan Disimpan",
        "green"
      );
      ...
      showAlert(
        err?.message ||
          "Gagal memperbarui data anak magang.",
        "Gagal Update Data",
        "red"
      );
    } finally {
